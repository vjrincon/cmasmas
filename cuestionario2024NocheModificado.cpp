...
main()
{
	...
	if (idioma==1)
		...
		cout<<"Estas en idioma-EspaÃ±ol\n";
			...
			break;		
			case 5:
				//Preguntas hechas por Estefany Sequera y Jeison Coronado Carga nro 2
			case 5:
			...
			case 7: 
					...
					cout<<"1-Â¿cuales son los tres pilares principales de la ciberseguridad?"<<endl;
					...
					cout<<"		2-Â¿CuÃ¡les son los principales tipos de ataques y alertas actuales?"<<endl;
					...
					cout<<"		3-Â¿A que se le considera Antispyware?"<<endl;
					...
					cout<<"c)Herramienta de software diseÃ±ada para detectar y eliminar programas maliciosos"<<endl;
					cout<<"d)ninguna de las anteriores"<<endl;
					cin>>respuesta;
					...
					cout<<"5-Â¿Cual es el objetivo de la ciberseguridad?"<<endl;
					...
					cout<<"b)Es el estudio que comprende el anÃ¡lisis y gestiÃ³n de sistemas llevado a cabo por profesionales en tecnologÃ­as de la informaciÃ³n (TI) con el objetivode identificar, enumerar y describir las diversas vulnerabilidades"<<endl;
					cout<<"c)Es dirigir las transacciones comerciales entre empresas, utilizando medios telemÃ¡ticos como EDI (Electronic Data Interchange) o el Comercio ElectrÃ³nico."<<endl;
					...
					cout<<"6-Â¿Que es un dominio en ciberseguridad?"<<endl;
					...
					cout<<"7-Â¿cuales son las fases de la ciberseguridad?"<<endl;
					...
					cout<<"8-Â¿Que es la criptografia en la seguridad cibernetica ?"<<endl;
					...
					cout<<"c)Es una prÃ¡ctica que consiste en proteger informaciÃ³n mediante el uso de algoritmos codificados, hashes y firmas"<<endl;
					...
					cout<<"10-Â¿Cuales son los beneficios de la ciberseguridad?"<<endl;
